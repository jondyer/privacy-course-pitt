...
\begin{itemize}\tightlist
  ...
  \item The difference between two close strings vs. two of the same string is very small, although becomes more noticeable with a longer input.
\end{itemize}

\image{naive_results.png}

This may also be clearer from the following graph of the real-time taken by each comparison type. Notice that the difference between two different strings of the same length and two close strings is more dramatic as the length increases.
